...
def euler_state(x_quat):
    ...
    [phi, theta, psi] = quaternion_to_euler(e)
...
def quaternion_state(x_euler):
    ...
    e = euler_to_quaternion(x_euler.item(6), x_euler.item(7), x_euler.item(8))
