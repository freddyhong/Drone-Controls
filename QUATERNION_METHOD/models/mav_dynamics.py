...
#             R = quaternion_to_euler(self._state[6:10])  # R: body to inertial  R.T: inertial to body
...
#         """
#         phi, theta, psi = quaternion_to_rotation(self._state[6:10])
